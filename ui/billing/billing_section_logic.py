...
from .action_buttons_ui import ActionButtonsUI
from .billing_list_ui import BillingListWidget
from .billing_section_ui import BillingSectionUI
from .billing_keypad_logic import BillingKeypad
from database.bill_dao import BillDAO
from database.product_repository import ProductRepository
from ..utils.ui_helpers import toggle_visibility
...
class BillingSection:
    ...
    def load_bill(self, bill_id):
        bill_dao = BillDAO()
        bill = bill_dao.get_bill(bill_id)
        if not bill:
